...
class AdminProjectEdit extends StatefulWidget {
  ...
  @override
  State<AdminProjectEdit> createState() => _AdminProjectEditState();
}

class _AdminProjectEditState extends State<AdminProjectEdit> {
  ...
  Future<void> _loadProjectData() async {
    ...
    if (data != null) {
      ...
      _links = List<Map<String, dynamic>>.from(data['links'] ?? []);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('プロジェクト編集', style: TextStyle(color: Colors.white)),
